...
const Home = () => {
  ...
  const aboutHeading = "Perfect Food  Perfect Moments";
    ...
    <MainLayout>
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-4xl font-light text-black mb-6 flex flex-wrap justify-center">
            {aboutHeading.split("").map((char, i) => (
              <motion.span
                key={i}
                custom={i}
                initial="hidden"
